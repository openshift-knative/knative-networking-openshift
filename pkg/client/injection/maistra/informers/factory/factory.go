...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/openshift-knative/knative-serving-networking-openshift/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
