...
import (
	...
	client "github.com/openshift-knative/knative-serving-networking-openshift/pkg/client/injection/openshift/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/openshift/client-go/route/informers/externalversions.SharedInformerFactory from context.")
	}
