...
import (
	...
	externalversions "github.com/openshift-knative/knative-serving-networking-openshift/pkg/client/maistra/informers/externalversions"
	client "github.com/openshift-knative/knative-serving-networking-openshift/pkg/client/maistra/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/openshift-knative/knative-serving-networking-openshift/pkg/client/maistra/informers/externalversions.SharedInformerFactory from context.")
	}
